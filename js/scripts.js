...
$("#mc-embedded-subscribe-creator").click(function() {
    var creatorEmail = $("mce-EMAIL-creator").val();
    ...
    .then(function (response) {
        if (response.success){
            ...
            removeStuffAndReload(creatorEmail);
        }
      })
...
$("#mc-embedded-subscribe-fans").click(function() {
    var fanEmail = $("mce-EMAIL-fans").val();
...
function removeStuffAndReload(email) {
    document.getElementById("mc_embed_signup").style.visibility = "hidden";
    var name = window.location.pathname;
    name = name.split("/")[1];
    window.location.replace(window.location.href+"?index="+name+"&code="+md5(email).substring(0,8));
}
